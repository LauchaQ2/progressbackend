...
export const getProductos_Dimensiones = async (req, res) => {
...
export const getProductos_DimensionesById = async (req, res) => {
    const { id } = req.params
...
export const DeleteProductos_DimensionesById = async (req, res) => {
    const { id } = req.params
...
export const createNewProduct_Dimension = async (req, res) => {
