...
export const getSeñaleticas_Imagenes = async (req, res) => {
...
export const createNewSeñaletica_Imagenes = async (req, res) => {
...
export const DeleteSeñaleticaById = async (req, res) => {
    const { id } = req.params
